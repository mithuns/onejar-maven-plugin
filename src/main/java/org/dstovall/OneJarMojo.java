...
public class OneJarMojo extends AbstractMojo {
  ...
  public void execute() throws MojoExecutionException {
    ...
    File onejarFile = new File(outputDirectory, filename);
      try (JarOutputStream out = new JarOutputStream(new FileOutputStream(onejarFile, false), getManifest())) {
        ...
        try (JarInputStream template = openOnejarTemplateArchive()) {
          ZipEntry entry;
  ...
  private Manifest getManifest() throws IOException {
    ...
    try (ZipInputStream zipIS = openOnejarTemplateArchive()) {
      ...
      // some for "implementation-version", and others use various capitalizations of
